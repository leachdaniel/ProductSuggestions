...
namespace GraphQLProductsDemo.CreateDatabase
{
    public static class LocalDatabaseExtensions
    {
        public static void RegisterAndPopulateLocalDatabase(this IServiceCollection services)
        {
            ...
            {
                ISqlLocalDbInstanceInfo instance = sp.GetRequiredService<SqlLocalDbApi>().GetOrCreateInstance("GraphQLProductsDemo");
